...
main(int argc, char **argv)
{
  ...
  4c:	84858593          	addi	a1,a1,-1976 # 890 <lock_release+0x18>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3da:	53250513          	addi	a0,a0,1330 # 908 <digits>
 3de:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49a:	41ac8c93          	addi	s9,s9,1050 # 8b0 <lock_release+0x38>
 ...
 4a8:	464b8b93          	addi	s7,s7,1124 # 908 <digits>
 ...
 5ce:	2de98993          	addi	s3,s3,734 # 8a8 <lock_release+0x30>
        while(*s != 0){
 5d2:	85ee                	mv	a1,s11
...
int thread_create(void *(*start_routine)(void*), void *arg) 
{
 ...
 82a:	b64080e7          	jalr	-1180(ra) # 38a <clone>
	
	if(tid == 0) {
 82e:	c901                	beqz	a0,83e <thread_create+0x34>
		(*start_routine) (arg);
		exit(0);
	}
	return 0;
 ...
 848:	aa6080e7          	jalr	-1370(ra) # 2ea <exit>

000000000000084c <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 850:	0800                	addi	s0,sp,16
	*lock = 0;
 852:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 856:	6422                	ld	s0,8(sp)
 858:	0141                	addi	sp,sp,16
 85a:	8082                	ret

000000000000085c <lock_acquire>:
void lock_acquire(lock_t *lock)
{
 ...
 862:	4705                	li	a4,1
 864:	87ba                	mv	a5,a4
 866:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 86a:	2781                	sext.w	a5,a5
 86c:	ffe5                	bnez	a5,864 <lock_acquire+0x8>
	__sync_synchronize();
 86e:	0ff0000f          	fence
}
 872:	6422                	ld	s0,8(sp)
...
void lock_release(lock_t *lock)
{
 ...
 882:	0f50000f          	fence	iorw,ow
 886:	0805202f          	amoswap.w	zero,zero,(a0)
}
 88a:	6422                	ld	s0,8(sp)
