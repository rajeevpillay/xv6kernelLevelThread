...
main(void)
{
  ...
  12:	92250513          	addi	a0,a0,-1758 # 930 <lock_release+0x24>
  ...
  3a:	90290913          	addi	s2,s2,-1790 # 938 <lock_release+0x2c>
  3e:	854a                	mv	a0,s2
  ...
  6e:	91e50513          	addi	a0,a0,-1762 # 988 <lock_release+0x7c>
  ...
  8c:	8a850513          	addi	a0,a0,-1880 # 930 <lock_release+0x24>
  90:	00000097          	auipc	ra,0x0
  94:	336080e7          	jalr	822(ra) # 3c6 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	89650513          	addi	a0,a0,-1898 # 930 <lock_release+0x24>
  a2:	00000097          	auipc	ra,0x0
  a6:	31c080e7          	jalr	796(ra) # 3be <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	8a450513          	addi	a0,a0,-1884 # 950 <lock_release+0x44>
  ...
  d2:	89a50513          	addi	a0,a0,-1894 # 968 <lock_release+0x5c>
  d6:	00000097          	auipc	ra,0x0
  da:	2e0080e7          	jalr	736(ra) # 3b6 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	89250513          	addi	a0,a0,-1902 # 970 <lock_release+0x64>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46e:	59e50513          	addi	a0,a0,1438 # a08 <digits>
 472:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 52e:	486c8c93          	addi	s9,s9,1158 # 9b0 <lock_release+0xa4>
 ...
 53c:	4d0b8b93          	addi	s7,s7,1232 # a08 <digits>
 ...
 662:	34a98993          	addi	s3,s3,842 # 9a8 <lock_release+0x9c>
        while(*s != 0){
 666:	85ee                	mv	a1,s11
...
000000000000089e <thread_create>:
#include "user/user.h"
...
int thread_create(void *(*start_routine)(void*), void *arg) 
{
 ...
 8b4:	f08080e7          	jalr	-248(ra) # 7b8 <malloc>
	
	int tid  = clone(stk_addr,stksz);
 8b8:	6585                	lui	a1,0x1
 8ba:	00000097          	auipc	ra,0x0
 8be:	b64080e7          	jalr	-1180(ra) # 41e <clone>
	
	if(tid == 0) {
 8c2:	c901                	beqz	a0,8d2 <thread_create+0x34>
		(*start_routine) (arg);
		exit(0);
	}
	return 0;
 ...
 8dc:	aa6080e7          	jalr	-1370(ra) # 37e <exit>
...
void lock_init(lock_t *lock)
{
 ...
 8e4:	0800                	addi	s0,sp,16
	*lock = 0;
 8e6:	00052023          	sw	zero,0(a0) # 1000 <argv>
}
 8ea:	6422                	ld	s0,8(sp)
