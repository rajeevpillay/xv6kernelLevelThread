...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	34650513          	addi	a0,a0,838 # 13e0 <lock_release+0x24>
      a2:	00001097          	auipc	ra,0x1
      a6:	df4080e7          	jalr	-524(ra) # e96 <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	33650513          	addi	a0,a0,822 # 13e0 <lock_release+0x24>
      b2:	00001097          	auipc	ra,0x1
      b6:	dec080e7          	jalr	-532(ra) # e9e <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	32c50513          	addi	a0,a0,812 # 13e8 <lock_release+0x2c>
  ...
  chdir("/");
      ...
      da:	33250513          	addi	a0,a0,818 # 1408 <lock_release+0x4c>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	33298993          	addi	s3,s3,818 # 1418 <lock_release+0x5c>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	32098993          	addi	s3,s3,800 # 1410 <lock_release+0x54>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	5a7d                	li	s4,-1
      fc:	00001917          	auipc	s2,0x1
     100:	5cc90913          	addi	s2,s2,1484 # 16c8 <lock_release+0x30c>
    ...
    if(what == 1){
     ...
     10e:	31650513          	addi	a0,a0,790 # 1420 <lock_release+0x64>
    ...
    if(what == 1){
     ...
     168:	2cc50513          	addi	a0,a0,716 # 1430 <lock_release+0x74>
     ...
     182:	2a250513          	addi	a0,a0,674 # 1420 <lock_release+0x64>
     ...
     194:	25050513          	addi	a0,a0,592 # 13e0 <lock_release+0x24>
     ...
     1a6:	2a650513          	addi	a0,a0,678 # 1448 <lock_release+0x8c>
     1aa:	00001097          	auipc	ra,0x1
     1ae:	cd4080e7          	jalr	-812(ra) # e7e <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	25650513          	addi	a0,a0,598 # 1408 <lock_release+0x4c>
     1ba:	00001097          	auipc	ra,0x1
     1be:	ce4080e7          	jalr	-796(ra) # e9e <chdir>
     1c2:	b785                	j	122 <go+0xaa>
        printf("grind: chdir grindir failed\n");
     1c4:	00001517          	auipc	a0,0x1
     1c8:	22450513          	addi	a0,a0,548 # 13e8 <lock_release+0x2c>
     ...
     1f0:	26450513          	addi	a0,a0,612 # 1450 <lock_release+0x94>
     ...
     212:	25250513          	addi	a0,a0,594 # 1460 <lock_release+0xa4>
     ...
     256:	1ce50513          	addi	a0,a0,462 # 1420 <lock_release+0x64>
     25a:	00001097          	auipc	ra,0x1
     25e:	c3c080e7          	jalr	-964(ra) # e96 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     262:	20200593          	li	a1,514
     266:	00001517          	auipc	a0,0x1
     26a:	21250513          	addi	a0,a0,530 # 1478 <lock_release+0xbc>
     ...
     282:	20a50513          	addi	a0,a0,522 # 1488 <lock_release+0xcc>
     ...
     294:	20050513          	addi	a0,a0,512 # 1490 <lock_release+0xd4>
     298:	00001097          	auipc	ra,0x1
     29c:	bfe080e7          	jalr	-1026(ra) # e96 <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     2a0:	20200593          	li	a1,514
     2a4:	00001517          	auipc	a0,0x1
     2a8:	1f450513          	addi	a0,a0,500 # 1498 <lock_release+0xdc>
     ...
     2c0:	1ec50513          	addi	a0,a0,492 # 14a8 <lock_release+0xec>
     ...
     2d2:	1a250513          	addi	a0,a0,418 # 1470 <lock_release+0xb4>
     2d6:	00001097          	auipc	ra,0x1
     2da:	ba8080e7          	jalr	-1112(ra) # e7e <unlink>
      link("../grindir/./../a", "../b");
     2de:	00001597          	auipc	a1,0x1
     2e2:	16a58593          	addi	a1,a1,362 # 1448 <lock_release+0x8c>
     2e6:	00001517          	auipc	a0,0x1
     2ea:	1ca50513          	addi	a0,a0,458 # 14b0 <lock_release+0xf4>
     ...
     2fc:	1d050513          	addi	a0,a0,464 # 14c8 <lock_release+0x10c>
     300:	00001097          	auipc	ra,0x1
     304:	b7e080e7          	jalr	-1154(ra) # e7e <unlink>
      link(".././b", "/grindir/../a");
     308:	00001597          	auipc	a1,0x1
     30c:	14858593          	addi	a1,a1,328 # 1450 <lock_release+0x94>
     310:	00001517          	auipc	a0,0x1
     314:	1c850513          	addi	a0,a0,456 # 14d8 <lock_release+0x11c>
     ...
     348:	19c50513          	addi	a0,a0,412 # 14e0 <lock_release+0x124>
     ...
     396:	14e50513          	addi	a0,a0,334 # 14e0 <lock_release+0x124>
     ...
     3a8:	a8a080e7          	jalr	-1398(ra) # e2e <exit>
      ...
      sbrk(6011);
     3ac:	6505                	lui	a0,0x1
     3ae:	77b50513          	addi	a0,a0,1915 # 177b <lock_release+0x3bf>
     ...
     3f6:	10650513          	addi	a0,a0,262 # 14f8 <lock_release+0x13c>
     ...
     422:	0a250513          	addi	a0,a0,162 # 14c0 <lock_release+0x104>
     ...
     444:	0a050513          	addi	a0,a0,160 # 14e0 <lock_release+0x124>
     ...
     45e:	0ae50513          	addi	a0,a0,174 # 1508 <lock_release+0x14c>
     ...
     4ac:	03850513          	addi	a0,a0,56 # 14e0 <lock_release+0x124>
     ...
     508:	01c50513          	addi	a0,a0,28 # 1520 <lock_release+0x164>
     ...
     534:	00858593          	addi	a1,a1,8 # 1538 <lock_release+0x17c>
     ...
     636:	eae50513          	addi	a0,a0,-338 # 14e0 <lock_release+0x124>
     ...
     650:	f3450513          	addi	a0,a0,-204 # 1580 <lock_release+0x1c4>
     ...
     664:	f2050513          	addi	a0,a0,-224 # 1580 <lock_release+0x1c4>
     ...
     67c:	ec058593          	addi	a1,a1,-320 # 1538 <lock_release+0x17c>
     ...
     6c2:	ec250513          	addi	a0,a0,-318 # 1580 <lock_release+0x1c4>
     6c6:	00000097          	auipc	ra,0x0
     6ca:	7b8080e7          	jalr	1976(ra) # e7e <unlink>
     6ce:	bc91                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     6d0:	00001517          	auipc	a0,0x1
     6d4:	eb850513          	addi	a0,a0,-328 # 1588 <lock_release+0x1cc>
     ...
     6ee:	eb650513          	addi	a0,a0,-330 # 15a0 <lock_release+0x1e4>
     ...
     708:	eb450513          	addi	a0,a0,-332 # 15b8 <lock_release+0x1fc>
     ...
     724:	eb050513          	addi	a0,a0,-336 # 15d0 <lock_release+0x214>
     ...
     73e:	ebe50513          	addi	a0,a0,-322 # 15f8 <lock_release+0x23c>
     ...
     826:	e7658593          	addi	a1,a1,-394 # 1698 <lock_release+0x2dc>
     ...
     84a:	e5a50513          	addi	a0,a0,-422 # 16a0 <lock_release+0x2e4>
     ...
     864:	cc058593          	addi	a1,a1,-832 # 1520 <lock_release+0x164>
     868:	4509                	li	a0,2
     ...
     880:	ca458593          	addi	a1,a1,-860 # 1520 <lock_release+0x164>
     884:	4509                	li	a0,2
     ...
     8dc:	d4858593          	addi	a1,a1,-696 # 1620 <lock_release+0x264>
     8e0:	4509                	li	a0,2
     ...
     950:	b9458593          	addi	a1,a1,-1132 # 14e0 <lock_release+0x124>
     954:	4509                	li	a0,2
     ...
     99c:	c8858593          	addi	a1,a1,-888 # 1620 <lock_release+0x264>
     9a0:	4509                	li	a0,2
     ...
     9e0:	c4458593          	addi	a1,a1,-956 # 1620 <lock_release+0x264>
     9e4:	4509                	li	a0,2
     ...
     a48:	a9c58593          	addi	a1,a1,-1380 # 14e0 <lock_release+0x124>
     a4c:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a70:	a5450513          	addi	a0,a0,-1452 # 14c0 <lock_release+0x104>
     a74:	00000097          	auipc	ra,0x0
     a78:	40a080e7          	jalr	1034(ra) # e7e <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	9f450513          	addi	a0,a0,-1548 # 1470 <lock_release+0xb4>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aba:	a2a50513          	addi	a0,a0,-1494 # 14e0 <lock_release+0x124>
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     ae8:	629c                	ld	a5,0(a3)
     aea:	6709                	lui	a4,0x2
     aec:	c0970713          	addi	a4,a4,-1015 # 1c09 <digits+0x481>
    ...
    printf("grind: fork failed\n");
     ...
     b02:	9e250513          	addi	a0,a0,-1566 # 14e0 <lock_release+0x124>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f1e:	86e50513          	addi	a0,a0,-1938 # 1788 <digits>
     f22:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
     ...
     fde:	756c8c93          	addi	s9,s9,1878 # 1730 <lock_release+0x374>
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fec:	7a0b8b93          	addi	s7,s7,1952 # 1788 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1112:	61a98993          	addi	s3,s3,1562 # 1728 <lock_release+0x36c>
        while(*s != 0){
    1116:	85ee                	mv	a1,s11
...
000000000000134e <thread_create>:
#include "user/user.h"
...
int thread_create(void *(*start_routine)(void*), void *arg) 
{
    ...
    1354:	e426                	sd	s1,8(sp)
    1356:	e04a                	sd	s2,0(sp)
    1358:	1000                	addi	s0,sp,32
    135a:	84aa                	mv	s1,a0
    135c:	892e                	mv	s2,a1
	int stksz = 4096 * sizeof(void);
	void* stk_addr = (void*) malloc(stksz);
    135e:	6505                	lui	a0,0x1
    1360:	00000097          	auipc	ra,0x0
    1364:	f08080e7          	jalr	-248(ra) # 1268 <malloc>
	
	int tid  = clone(stk_addr,stksz);
    1368:	6585                	lui	a1,0x1
    136a:	00000097          	auipc	ra,0x0
    136e:	b64080e7          	jalr	-1180(ra) # ece <clone>
	
	if(tid == 0) {
    1372:	c901                	beqz	a0,1382 <thread_create+0x34>
		(*start_routine) (arg);
		exit(0);
	}
	return 0;
    ...
    138c:	aa6080e7          	jalr	-1370(ra) # e2e <exit>

0000000000001390 <lock_init>:
...
void lock_init(lock_t *lock)
{
	...
	*lock = 0;
    1396:	00052023          	sw	zero,0(a0) # 1000 <vprintf+0x5c>
}
    139a:	6422                	ld	s0,8(sp)
    139c:	0141                	addi	sp,sp,16
    139e:	8082                	ret

00000000000013a0 <lock_acquire>:
void lock_acquire(lock_t *lock)
{
    ...
    13a6:	4705                	li	a4,1
    13a8:	87ba                	mv	a5,a4
    13aa:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
    13ae:	2781                	sext.w	a5,a5
    13b0:	ffe5                	bnez	a5,13a8 <lock_acquire+0x8>
	__sync_synchronize();
    13b2:	0ff0000f          	fence
}
    13b6:	6422                	ld	s0,8(sp)
    13b8:	0141                	addi	sp,sp,16
    13ba:	8082                	ret

00000000000013bc <lock_release>:
void lock_release(lock_t *lock)
{
    ...
    13c6:	0f50000f          	fence	iorw,ow
    13ca:	0805202f          	amoswap.w	zero,zero,(a0)
}
