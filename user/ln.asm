...
main(int argc, char *argv[])
{
  ...
  14:	88058593          	addi	a1,a1,-1920 # 890 <lock_release+0x1c>
  18:	4509                	li	a0,2
  ...
  50:	85c58593          	addi	a1,a1,-1956 # 8a8 <lock_release+0x34>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d6:	54e50513          	addi	a0,a0,1358 # 920 <digits>
 3da:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 496:	436c8c93          	addi	s9,s9,1078 # 8c8 <lock_release+0x54>
 ...
 4a4:	480b8b93          	addi	s7,s7,1152 # 920 <digits>
 ...
 5ca:	2fa98993          	addi	s3,s3,762 # 8c0 <lock_release+0x4c>
        while(*s != 0){
 5ce:	85ee                	mv	a1,s11
...
0000000000000806 <thread_create>:
#include "user/user.h"
...
int thread_create(void *(*start_routine)(void*), void *arg) 
{
 ...
 81c:	f08080e7          	jalr	-248(ra) # 720 <malloc>
	
	int tid  = clone(stk_addr,stksz);
 820:	6585                	lui	a1,0x1
 822:	00000097          	auipc	ra,0x0
 826:	b64080e7          	jalr	-1180(ra) # 386 <clone>
	
	if(tid == 0) {
 82a:	c901                	beqz	a0,83a <thread_create+0x34>
		(*start_routine) (arg);
		exit(0);
	}
	return 0;
 ...
 844:	aa6080e7          	jalr	-1370(ra) # 2e6 <exit>

0000000000000848 <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 84c:	0800                	addi	s0,sp,16
	*lock = 0;
 84e:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 852:	6422                	ld	s0,8(sp)
 854:	0141                	addi	sp,sp,16
 856:	8082                	ret

0000000000000858 <lock_acquire>:
void lock_acquire(lock_t *lock)
{
 ...
 85e:	4705                	li	a4,1
 860:	87ba                	mv	a5,a4
 862:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 866:	2781                	sext.w	a5,a5
 868:	ffe5                	bnez	a5,860 <lock_acquire+0x8>
	__sync_synchronize();
 86a:	0ff0000f          	fence
}
 86e:	6422                	ld	s0,8(sp)
...
void lock_release(lock_t *lock)
{
 ...
 87e:	0f50000f          	fence	iorw,ow
 882:	0805202f          	amoswap.w	zero,zero,(a0)
}
 886:	6422                	ld	s0,8(sp)
