...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 460:	40cc8c93          	addi	s9,s9,1036 # 868 <lock_release+0x2a>
 ...
 46e:	456b8b93          	addi	s7,s7,1110 # 8c0 <digits>
 ...
 594:	2d098993          	addi	s3,s3,720 # 860 <lock_release+0x22>
        while(*s != 0){
 598:	85ee                	mv	a1,s11
...
00000000000007d0 <thread_create>:
#include "user/user.h"
...
int thread_create(void *(*start_routine)(void*), void *arg) 
{
 ...
 7e6:	f08080e7          	jalr	-248(ra) # 6ea <malloc>
	
	int tid  = clone(stk_addr,stksz);
 7ea:	6585                	lui	a1,0x1
 7ec:	00000097          	auipc	ra,0x0
 7f0:	b64080e7          	jalr	-1180(ra) # 350 <clone>
	
	if(tid == 0) {
 7f4:	c901                	beqz	a0,804 <thread_create+0x34>
		(*start_routine) (arg);
		exit(0);
	}
	return 0;
 ...
 80e:	aa6080e7          	jalr	-1370(ra) # 2b0 <exit>

0000000000000812 <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 816:	0800                	addi	s0,sp,16
	*lock = 0;
 818:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 81c:	6422                	ld	s0,8(sp)
 81e:	0141                	addi	sp,sp,16
 820:	8082                	ret

0000000000000822 <lock_acquire>:
void lock_acquire(lock_t *lock)
{
 ...
 828:	4705                	li	a4,1
 82a:	87ba                	mv	a5,a4
 82c:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 830:	2781                	sext.w	a5,a5
 832:	ffe5                	bnez	a5,82a <lock_acquire+0x8>
	__sync_synchronize();
 834:	0ff0000f          	fence
}
 838:	6422                	ld	s0,8(sp)
...
void lock_release(lock_t *lock)
{
 ...
 848:	0f50000f          	fence	iorw,ow
 84c:	0805202f          	amoswap.w	zero,zero,(a0)
}
 850:	6422                	ld	s0,8(sp)
