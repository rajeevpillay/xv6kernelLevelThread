...
wc(int fd, char *name)
{
  ...
  3c:	998a0a13          	addi	s4,s4,-1640 # 9d0 <lock_release+0x26>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	93250513          	addi	a0,a0,-1742 # 9e8 <lock_release+0x3e>
  ...
  e8:	8f450513          	addi	a0,a0,-1804 # 9d8 <lock_release+0x2e>
...
main(int argc, char *argv[])
{
 ...
 162:	89a58593          	addi	a1,a1,-1894 # 9f8 <lock_release+0x4e>
 166:	4501                	li	a0,0
 ...
 180:	88450513          	addi	a0,a0,-1916 # a00 <lock_release+0x56>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 50c:	57050513          	addi	a0,a0,1392 # a78 <digits>
 510:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5cc:	458c8c93          	addi	s9,s9,1112 # a20 <lock_release+0x76>
 ...
 5da:	4a2b8b93          	addi	s7,s7,1186 # a78 <digits>
 ...
 700:	31c98993          	addi	s3,s3,796 # a18 <lock_release+0x6e>
        while(*s != 0){
 704:	85ee                	mv	a1,s11
...
000000000000093c <thread_create>:
#include "user/user.h"
...
int thread_create(void *(*start_routine)(void*), void *arg) 
{
 ...
 952:	f08080e7          	jalr	-248(ra) # 856 <malloc>
	
	int tid  = clone(stk_addr,stksz);
 956:	6585                	lui	a1,0x1
 958:	00000097          	auipc	ra,0x0
 95c:	b64080e7          	jalr	-1180(ra) # 4bc <clone>
	
	if(tid == 0) {
 960:	c901                	beqz	a0,970 <thread_create+0x34>
		(*start_routine) (arg);
		exit(0);
	}
	return 0;
 ...
 97a:	aa6080e7          	jalr	-1370(ra) # 41c <exit>

000000000000097e <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 982:	0800                	addi	s0,sp,16
	*lock = 0;
 984:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 988:	6422                	ld	s0,8(sp)
 98a:	0141                	addi	sp,sp,16
 98c:	8082                	ret

000000000000098e <lock_acquire>:
void lock_acquire(lock_t *lock)
{
 ...
 994:	4705                	li	a4,1
 996:	87ba                	mv	a5,a4
 998:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 99c:	2781                	sext.w	a5,a5
 99e:	ffe5                	bnez	a5,996 <lock_acquire+0x8>
	__sync_synchronize();
 9a0:	0ff0000f          	fence
}
 9a4:	6422                	ld	s0,8(sp)
...
void lock_release(lock_t *lock)
{
 ...
 9b4:	0f50000f          	fence	iorw,ow
 9b8:	0805202f          	amoswap.w	zero,zero,(a0)
}
 9bc:	6422                	ld	s0,8(sp)
