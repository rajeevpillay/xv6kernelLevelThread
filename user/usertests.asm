...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	13250513          	addi	a0,a0,306 # 6170 <lock_release+0x22>
      ...
      74:	8082                	ret
{
      ...
      84:	11050513          	addi	a0,a0,272 # 6190 <lock_release+0x42>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	10050513          	addi	a0,a0,256 # 61a8 <lock_release+0x5a>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	10250513          	addi	a0,a0,258 # 61c8 <lock_release+0x7a>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	0ca50513          	addi	a0,a0,202 # 61b0 <lock_release+0x62>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	0d650513          	addi	a0,a0,214 # 61d8 <lock_release+0x8a>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	0d450513          	addi	a0,a0,212 # 6200 <lock_release+0xb2>
     134:	00006097          	auipc	ra,0x6
     138:	adc080e7          	jalr	-1316(ra) # 5c10 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	0c050513          	addi	a0,a0,192 # 6200 <lock_release+0xb2>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	0bc58593          	addi	a1,a1,188 # 6210 <lock_release+0xc2>
     15c:	00006097          	auipc	ra,0x6
     160:	a84080e7          	jalr	-1404(ra) # 5be0 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	09850513          	addi	a0,a0,152 # 6200 <lock_release+0xb2>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	09c58593          	addi	a1,a1,156 # 6218 <lock_release+0xca>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	06c50513          	addi	a0,a0,108 # 6200 <lock_release+0xb2>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	05650513          	addi	a0,a0,86 # 6220 <lock_release+0xd2>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	fcc50513          	addi	a0,a0,-52 # 6248 <lock_release+0xfa>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	fb8a8a93          	addi	s5,s5,-72 # 6248 <lock_release+0xfa>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	f4650513          	addi	a0,a0,-186 # 6258 <lock_release+0x10a>
     ...
     338:	f4450513          	addi	a0,a0,-188 # 6278 <lock_release+0x12a>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	f3250513          	addi	a0,a0,-206 # 6290 <lock_release+0x142>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	f1e98993          	addi	s3,s3,-226 # 6290 <lock_release+0x142>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	ed250513          	addi	a0,a0,-302 # 6290 <lock_release+0x142>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	e4258593          	addi	a1,a1,-446 # 6218 <lock_release+0xca>
    ...
    printf("write failed\n");
     ...
     3f0:	ec450513          	addi	a0,a0,-316 # 62b0 <lock_release+0x162>
    ...
    exit(1);
     ...
     40a:	e9250513          	addi	a0,a0,-366 # 6298 <lock_release+0x14a>
    ...
    printf("open junk failed\n");
     ...
     424:	e7850513          	addi	a0,a0,-392 # 6298 <lock_release+0x14a>
  ...
  unlink("junk");
     ...
     448:	e4c50513          	addi	a0,a0,-436 # 6290 <lock_release+0x142>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	d70a0a13          	addi	s4,s4,-656 # 62c0 <lock_release+0x172>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	ccc50513          	addi	a0,a0,-820 # 62c8 <lock_release+0x17a>
     ...
     61e:	cc650513          	addi	a0,a0,-826 # 62e0 <lock_release+0x192>
     ...
     63c:	cd850513          	addi	a0,a0,-808 # 6310 <lock_release+0x1c2>
     ...
     656:	cee50513          	addi	a0,a0,-786 # 6340 <lock_release+0x1f2>
     ...
     674:	ce050513          	addi	a0,a0,-800 # 6350 <lock_release+0x202>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	cd2a0a13          	addi	s4,s4,-814 # 6380 <lock_release+0x232>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	b62a8a93          	addi	s5,s5,-1182 # 6218 <lock_release+0xca>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	c2c50513          	addi	a0,a0,-980 # 6388 <lock_release+0x23a>
     ...
     77e:	c2650513          	addi	a0,a0,-986 # 63a0 <lock_release+0x252>
     ...
     798:	bac50513          	addi	a0,a0,-1108 # 6340 <lock_release+0x1f2>
     ...
     7b2:	c2250513          	addi	a0,a0,-990 # 63d0 <lock_release+0x282>
     ...
     7d0:	c1c50513          	addi	a0,a0,-996 # 63e8 <lock_release+0x29a>
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	9ee58593          	addi	a1,a1,-1554 # 6210 <lock_release+0xc2>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	9c250513          	addi	a0,a0,-1598 # 6200 <lock_release+0xb2>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	99650513          	addi	a0,a0,-1642 # 6200 <lock_release+0xb2>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	98250513          	addi	a0,a0,-1662 # 6200 <lock_release+0xb2>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	bbc58593          	addi	a1,a1,-1092 # 6478 <lock_release+0x32a>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	90250513          	addi	a0,a0,-1790 # 6200 <lock_release+0xb2>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	ad650513          	addi	a0,a0,-1322 # 6418 <lock_release+0x2ca>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	ada50513          	addi	a0,a0,-1318 # 6438 <lock_release+0x2ea>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     976:	ad650513          	addi	a0,a0,-1322 # 6448 <lock_release+0x2fa>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	ada50513          	addi	a0,a0,-1318 # 6468 <lock_release+0x31a>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a6:	aa650513          	addi	a0,a0,-1370 # 6448 <lock_release+0x2fa>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	ac050513          	addi	a0,a0,-1344 # 6480 <lock_release+0x332>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	ac250513          	addi	a0,a0,-1342 # 64a0 <lock_release+0x352>
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	aae50513          	addi	a0,a0,-1362 # 64c0 <lock_release+0x372>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	abe98993          	addi	s3,s3,-1346 # 64e8 <lock_release+0x39a>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	aeea8a93          	addi	s5,s5,-1298 # 6520 <lock_release+0x3d2>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	a4850513          	addi	a0,a0,-1464 # 64c0 <lock_release+0x372>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	a0c50513          	addi	a0,a0,-1524 # 64c0 <lock_release+0x372>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	9ea50513          	addi	a0,a0,-1558 # 64c8 <lock_release+0x37a>
    ...
    exit(1);
     ...
     b00:	9fc50513          	addi	a0,a0,-1540 # 64f8 <lock_release+0x3aa>
     ...
     b1e:	a1650513          	addi	a0,a0,-1514 # 6530 <lock_release+0x3e2>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	a2250513          	addi	a0,a0,-1502 # 6558 <lock_release+0x40a>
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	a2650513          	addi	a0,a0,-1498 # 6578 <lock_release+0x42a>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	a2250513          	addi	a0,a0,-1502 # 6590 <lock_release+0x442>
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	a1050513          	addi	a0,a0,-1520 # 65b0 <lock_release+0x462>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	9be50513          	addi	a0,a0,-1602 # 65b0 <lock_release+0x462>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	97e50513          	addi	a0,a0,-1666 # 65b8 <lock_release+0x46a>
    ...
    exit(1);
     ...
     c5c:	98050513          	addi	a0,a0,-1664 # 65d8 <lock_release+0x48a>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	98c50513          	addi	a0,a0,-1652 # 6600 <lock_release+0x4b2>
  ...
  if(unlink("big") < 0){
     ...
     ca4:	91050513          	addi	a0,a0,-1776 # 65b0 <lock_release+0x462>
     ...
     cd0:	95450513          	addi	a0,a0,-1708 # 6620 <lock_release+0x4d2>
     ...
     cee:	95e50513          	addi	a0,a0,-1698 # 6648 <lock_release+0x4fa>
     ...
     d0c:	95850513          	addi	a0,a0,-1704 # 6660 <lock_release+0x512>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	96450513          	addi	a0,a0,-1692 # 6688 <lock_release+0x53a>
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	94e50513          	addi	a0,a0,-1714 # 66a0 <lock_release+0x552>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	96658593          	addi	a1,a1,-1690 # 66d0 <lock_release+0x582>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	91a50513          	addi	a0,a0,-1766 # 66a0 <lock_release+0x552>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	90450513          	addi	a0,a0,-1788 # 66a0 <lock_release+0x552>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	8ee50513          	addi	a0,a0,-1810 # 66a0 <lock_release+0x552>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	95258593          	addi	a1,a1,-1710 # 6718 <lock_release+0x5ca>
  ...
  unlink("unlinkread");
     ...
     e32:	87250513          	addi	a0,a0,-1934 # 66a0 <lock_release+0x552>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	86250513          	addi	a0,a0,-1950 # 66b0 <lock_release+0x562>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	86e50513          	addi	a0,a0,-1938 # 66d8 <lock_release+0x58a>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	87250513          	addi	a0,a0,-1934 # 66f8 <lock_release+0x5aa>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	87e50513          	addi	a0,a0,-1922 # 6720 <lock_release+0x5d2>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	88250513          	addi	a0,a0,-1918 # 6740 <lock_release+0x5f2>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	88650513          	addi	a0,a0,-1914 # 6760 <lock_release+0x612>
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	79258593          	addi	a1,a1,1938 # 66d0 <lock_release+0x582>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	82a58593          	addi	a1,a1,-2006 # 6788 <lock_release+0x63a>
     f66:	00006517          	auipc	a0,0x6
     f6a:	81a50513          	addi	a0,a0,-2022 # 6780 <lock_release+0x632>
  ...
  unlink("lf1");
     ...
     f7e:	80650513          	addi	a0,a0,-2042 # 6780 <lock_release+0x632>
     f82:	00005097          	auipc	ra,0x5
     f86:	c8e080e7          	jalr	-882(ra) # 5c10 <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	7f450513          	addi	a0,a0,2036 # 6780 <lock_release+0x632>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	7e650513          	addi	a0,a0,2022 # 6788 <lock_release+0x63a>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	7ae58593          	addi	a1,a1,1966 # 6788 <lock_release+0x63a>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	79850513          	addi	a0,a0,1944 # 6788 <lock_release+0x63a>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c18080e7          	jalr	-1000(ra) # 5c10 <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	78058593          	addi	a1,a1,1920 # 6780 <lock_release+0x632>
    1008:	00005517          	auipc	a0,0x5
    100c:	78050513          	addi	a0,a0,1920 # 6788 <lock_release+0x63a>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	76458593          	addi	a1,a1,1892 # 6780 <lock_release+0x632>
    1024:	00006517          	auipc	a0,0x6
    1028:	86c50513          	addi	a0,a0,-1940 # 6890 <lock_release+0x742>
    ...
    104a:	74a50513          	addi	a0,a0,1866 # 6790 <lock_release+0x642>
    ...
    1066:	74650513          	addi	a0,a0,1862 # 67a8 <lock_release+0x65a>
    ...
    1082:	74250513          	addi	a0,a0,1858 # 67c0 <lock_release+0x672>
    ...
    109e:	74650513          	addi	a0,a0,1862 # 67e0 <lock_release+0x692>
    ...
    10ba:	75a50513          	addi	a0,a0,1882 # 6810 <lock_release+0x6c2>
    ...
    10d6:	75650513          	addi	a0,a0,1878 # 6828 <lock_release+0x6da>
    ...
    10f2:	75250513          	addi	a0,a0,1874 # 6840 <lock_release+0x6f2>
    ...
    110e:	75e50513          	addi	a0,a0,1886 # 6868 <lock_release+0x71a>
    ...
    112a:	77250513          	addi	a0,a0,1906 # 6898 <lock_release+0x74a>
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	76098993          	addi	s3,s3,1888 # 68b8 <lock_release+0x76a>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	73450513          	addi	a0,a0,1844 # 68c8 <lock_release+0x77a>
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	6eea0a13          	addi	s4,s4,1774 # 68e8 <lock_release+0x79a>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	69c50513          	addi	a0,a0,1692 # 68e8 <lock_release+0x79a>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	63450513          	addi	a0,a0,1588 # 68f0 <lock_release+0x7a2>
    ...
    12e0:	63450513          	addi	a0,a0,1588 # 6910 <lock_release+0x7c2>
    ...
    12fc:	63850513          	addi	a0,a0,1592 # 6930 <lock_release+0x7e2>
...
000000000000134a <badarg>:
{
    ...
    1368:	e4498993          	addi	s3,s3,-444 # 61a8 <lock_release+0x5a>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	79a78793          	addi	a5,a5,1946 # 7b88 <lock_release+0x1a3a>
  ...
  if(pid == 0){
    ...
    144e:	17e78793          	addi	a5,a5,382 # 85c8 <lock_release+0x247a>
    ...
    1472:	d3a50513          	addi	a0,a0,-710 # 61a8 <lock_release+0x5a>
    ...
    148a:	55250513          	addi	a0,a0,1362 # 69d8 <lock_release+0x88a>
    ...
    14aa:	4aa50513          	addi	a0,a0,1194 # 6950 <lock_release+0x802>
    ...
    14ca:	4aa50513          	addi	a0,a0,1194 # 6970 <lock_release+0x822>
    ...
    14ec:	4a850513          	addi	a0,a0,1192 # 6990 <lock_release+0x842>
    ...
    150c:	4b050513          	addi	a0,a0,1200 # 69b8 <lock_release+0x86a>
    ...
    1526:	91650513          	addi	a0,a0,-1770 # 6e38 <lock_release+0xcea>
  ...
  if(st != 747){
    ...
    1570:	49450513          	addi	a0,a0,1172 # 6a00 <lock_release+0x8b2>
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	c6250513          	addi	a0,a0,-926 # 6200 <lock_release+0xb2>
  ...
  if(pid == 0){
    ...
    15cc:	c38a0a13          	addi	s4,s4,-968 # 6200 <lock_release+0xb2>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	490a8a93          	addi	s5,s5,1168 # 6a60 <lock_release+0x912>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	3f050513          	addi	a0,a0,1008 # 6a30 <lock_release+0x8e2>
    ...
    1660:	3ec50513          	addi	a0,a0,1004 # 6a48 <lock_release+0x8fa>
    ...
    167e:	3f650513          	addi	a0,a0,1014 # 6a70 <lock_release+0x922>
    ...
    169c:	b68a0a13          	addi	s4,s4,-1176 # 6200 <lock_release+0xb2>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	3f0a8a93          	addi	s5,s5,1008 # 6a90 <lock_release+0x942>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	b1650513          	addi	a0,a0,-1258 # 6200 <lock_release+0xb2>
  ...
  exit(xstatus);
    ...
    170c:	34050513          	addi	a0,a0,832 # 6a48 <lock_release+0x8fa>
    ...
    172a:	37250513          	addi	a0,a0,882 # 6a98 <lock_release+0x94a>
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	a5a78793          	addi	a5,a5,-1446 # 61a8 <lock_release+0x5a>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	35e78793          	addi	a5,a5,862 # 6ab8 <lock_release+0x96a>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	35650513          	addi	a0,a0,854 # 6ac0 <lock_release+0x972>
  ...
  if(pid == 0) {
    ...
    179c:	32850513          	addi	a0,a0,808 # 6ac0 <lock_release+0x972>
    ...
    17b8:	32c50513          	addi	a0,a0,812 # 6ae0 <lock_release+0x992>
    ...
    17d4:	26050513          	addi	a0,a0,608 # 6a30 <lock_release+0x8e2>
    ...
    17f0:	2dc50513          	addi	a0,a0,732 # 6ac8 <lock_release+0x97a>
    ...
    180e:	99e50513          	addi	a0,a0,-1634 # 61a8 <lock_release+0x5a>
  ...
  if(xstatus != 0)
    ...
    1842:	2b250513          	addi	a0,a0,690 # 6af0 <lock_release+0x9a2>
    ...
    185e:	2ae50513          	addi	a0,a0,686 # 6b08 <lock_release+0x9ba>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1872:	25250513          	addi	a0,a0,594 # 6ac0 <lock_release+0x972>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	ce050513          	addi	a0,a0,-800 # 6578 <lock_release+0x42a>
    ...
    18b8:	19450513          	addi	a0,a0,404 # 6a48 <lock_release+0x8fa>
  ...
  unlink("echo-ok");
    ...
    18d2:	1f250513          	addi	a0,a0,498 # 6ac0 <lock_release+0x972>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	22850513          	addi	a0,a0,552 # 6b20 <lock_release+0x9d2>
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	18050513          	addi	a0,a0,384 # 6b38 <lock_release+0x9ea>
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	11250513          	addi	a0,a0,274 # 6b50 <lock_release+0xa02>
    ...
    1a5e:	10e50513          	addi	a0,a0,270 # 6b68 <lock_release+0xa1a>
    ...
    1a90:	0f450513          	addi	a0,a0,244 # 6b80 <lock_release+0xa32>
    ...
    1ad0:	0d450513          	addi	a0,a0,212 # 6ba0 <lock_release+0xa52>
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	ef250513          	addi	a0,a0,-270 # 6a30 <lock_release+0x8e2>
    ...
    1b5e:	05e50513          	addi	a0,a0,94 # 6bb8 <lock_release+0xa6a>
    ...
    1b7a:	05a50513          	addi	a0,a0,90 # 6bd0 <lock_release+0xa82>
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	e4250513          	addi	a0,a0,-446 # 6a30 <lock_release+0x8e2>
    ...
    1c16:	e1e50513          	addi	a0,a0,-482 # 6a30 <lock_release+0x8e2>
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	f6450513          	addi	a0,a0,-156 # 6bf0 <lock_release+0xaa2>
    ...
    1ca2:	f22080e7          	jalr	-222(ra) # 5bc0 <exit>
{
    ...
    1ce8:	f1c50513          	addi	a0,a0,-228 # 6c00 <lock_release+0xab2>
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	10650513          	addi	a0,a0,262 # 6e38 <lock_release+0xcea>
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	06850513          	addi	a0,a0,104 # 6e38 <lock_release+0xcea>
    ...
    1e00:	ccc50513          	addi	a0,a0,-820 # 6ac8 <lock_release+0x97a>
    ...
    1e72:	db250513          	addi	a0,a0,-590 # 6c20 <lock_release+0xad2>
    ...
    1ea6:	d9650513          	addi	a0,a0,-618 # 6c38 <lock_release+0xaea>
    ...
    1f0c:	d5850513          	addi	a0,a0,-680 # 6c60 <lock_release+0xb12>
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	27050513          	addi	a0,a0,624 # 6218 <lock_release+0xca>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	234a8a93          	addi	s5,s5,564 # 6218 <lock_release+0xca>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	c9cb8b93          	addi	s7,s7,-868 # 6c88 <lock_release+0xb3a>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	a3850513          	addi	a0,a0,-1480 # 6a30 <lock_release+0x8e2>
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	bee50513          	addi	a0,a0,-1042 # 6ca8 <lock_release+0xb5a>
  ...
  if(wait(0) != -1){
    ...
    2120:	b7450513          	addi	a0,a0,-1164 # 6c90 <lock_release+0xb42>
    ...
    213c:	b9850513          	addi	a0,a0,-1128 # 6cd0 <lock_release+0xb82>
    ...
    2158:	b9450513          	addi	a0,a0,-1132 # 6ce8 <lock_release+0xb9a>
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	85c50513          	addi	a0,a0,-1956 # 6a30 <lock_release+0x8e2>
    ...
    21fa:	b0a50513          	addi	a0,a0,-1270 # 6d00 <lock_release+0xbb2>
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	7b850513          	addi	a0,a0,1976 # 6a30 <lock_release+0x8e2>
    ...
    22a8:	a7c50513          	addi	a0,a0,-1412 # 6d20 <lock_release+0xbd2>
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	a6450513          	addi	a0,a0,-1436 # 6d38 <lock_release+0xbea>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	a3250513          	addi	a0,a0,-1486 # 6d38 <lock_release+0xbea>
  ...
  close(fd);
    ...
    2340:	a0c70713          	addi	a4,a4,-1524 # 6d48 <lock_release+0xbfa>
    ...
    2394:	a9850513          	addi	a0,a0,-1384 # 6e28 <lock_release+0xcda>
    ...
    23b8:	a9450513          	addi	a0,a0,-1388 # 6e48 <lock_release+0xcfa>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	a5650513          	addi	a0,a0,-1450 # 6e68 <lock_release+0xd1a>
    ...
    2432:	60250513          	addi	a0,a0,1538 # 6a30 <lock_release+0x8e2>
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	59450513          	addi	a0,a0,1428 # 6a30 <lock_release+0x8e2>
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	92050513          	addi	a0,a0,-1760 # 6e38 <lock_release+0xcea>
    ...
    25cc:	8c850513          	addi	a0,a0,-1848 # 6e90 <lock_release+0xd42>
    ...
    25ec:	c9050513          	addi	a0,a0,-880 # 6278 <lock_release+0x12a>
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	50878793          	addi	a5,a5,1288 # 7b88 <lock_release+0x1a3a>
  ...
  if(ret != -1){
    ...
    26c6:	7e650513          	addi	a0,a0,2022 # 6ea8 <lock_release+0xd5a>
    ...
    26e4:	27050513          	addi	a0,a0,624 # 6950 <lock_release+0x802>
    ...
    2702:	27250513          	addi	a0,a0,626 # 6970 <lock_release+0x822>
    ...
    2722:	27250513          	addi	a0,a0,626 # 6990 <lock_release+0x842>
    ...
    2740:	27c50513          	addi	a0,a0,636 # 69b8 <lock_release+0x86a>
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	76050513          	addi	a0,a0,1888 # 6ee8 <lock_release+0xd9a>
  ...
  if(n >= 0){
    ...
    27bc:	75050513          	addi	a0,a0,1872 # 6f08 <lock_release+0xdba>
    ...
    27d6:	6de50513          	addi	a0,a0,1758 # 6eb0 <lock_release+0xd62>
    ...
    27f0:	6dc50513          	addi	a0,a0,1756 # 6ec8 <lock_release+0xd7a>
    ...
    280a:	6ea50513          	addi	a0,a0,1770 # 6ef0 <lock_release+0xda2>
  ...
  unlink("rwsbrk");
    ...
    282e:	6be50513          	addi	a0,a0,1726 # 6ee8 <lock_release+0xd9a>
    2832:	00003097          	auipc	ra,0x3
    2836:	3de080e7          	jalr	990(ra) # 5c10 <unlink>
  fd = open("README", O_RDONLY);
    283a:	4581                	li	a1,0
    283c:	00004517          	auipc	a0,0x4
    2840:	b4450513          	addi	a0,a0,-1212 # 6380 <lock_release+0x232>
  ...
  if(n >= 0){
    ...
    286a:	6d250513          	addi	a0,a0,1746 # 6f38 <lock_release+0xdea>
    ...
    2884:	67050513          	addi	a0,a0,1648 # 6ef0 <lock_release+0xda2>
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2904:	66050513          	addi	a0,a0,1632 # 6f60 <lock_release+0xe12>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	62e50513          	addi	a0,a0,1582 # 6f80 <lock_release+0xe32>
  ...
  if(c != a + 1){
    ...
    29ba:	62a50513          	addi	a0,a0,1578 # 6fe0 <lock_release+0xe92>
    ...
    29dc:	5c850513          	addi	a0,a0,1480 # 6fa0 <lock_release+0xe52>
    ...
    29f8:	5cc50513          	addi	a0,a0,1484 # 6fc0 <lock_release+0xe72>
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b42:	4c250513          	addi	a0,a0,1218 # 7000 <lock_release+0xeb2>
    ...
    2b5e:	4ee50513          	addi	a0,a0,1262 # 7048 <lock_release+0xefa>
    ...
    2b7e:	4ee50513          	addi	a0,a0,1262 # 7068 <lock_release+0xf1a>
    ...
    2b9e:	50e50513          	addi	a0,a0,1294 # 70a8 <lock_release+0xf5a>
    ...
    2bba:	52250513          	addi	a0,a0,1314 # 70d8 <lock_release+0xf8a>
    ...
    2bda:	53a50513          	addi	a0,a0,1338 # 7110 <lock_release+0xfc2>
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	52850513          	addi	a0,a0,1320 # 7138 <lock_release+0xfea>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fe8080e7          	jalr	-24(ra) # 5c00 <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	51650513          	addi	a0,a0,1302 # 7138 <lock_release+0xfea>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	4ca50513          	addi	a0,a0,1226 # 7140 <lock_release+0xff2>
    ...
    2c96:	4c650513          	addi	a0,a0,1222 # 7158 <lock_release+0x100a>
    ...
    2cb2:	e8a50513          	addi	a0,a0,-374 # 6b38 <lock_release+0x9ea>
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	49850513          	addi	a0,a0,1176 # 7170 <lock_release+0x1022>
  ...
  close(fd);
    ...
    2d24:	d2850513          	addi	a0,a0,-728 # 6a48 <lock_release+0x8fa>
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	0ca50513          	addi	a0,a0,202 # 6e38 <lock_release+0xcea>
  ...
  if(pid == 0){
    ...
    2dc8:	07450513          	addi	a0,a0,116 # 6e38 <lock_release+0xcea>
  ...
  if(pid == 0){
    ...
    2e28:	01450513          	addi	a0,a0,20 # 6e38 <lock_release+0xcea>
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	ea050513          	addi	a0,a0,-352 # 6e38 <lock_release+0xcea>
    ...
    2ff0:	1bc50513          	addi	a0,a0,444 # 61a8 <lock_release+0x5a>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	22078793          	addi	a5,a5,544 # 6218 <lock_release+0xca>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	31e50513          	addi	a0,a0,798 # 7348 <lock_release+0x11fa>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	16450513          	addi	a0,a0,356 # 71a0 <lock_release+0x1052>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	1a650513          	addi	a0,a0,422 # 71f8 <lock_release+0x10aa>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	20050513          	addi	a0,a0,512 # 7270 <lock_release+0x1122>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	25450513          	addi	a0,a0,596 # 72e0 <lock_release+0x1192>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	29a50513          	addi	a0,a0,666 # 7338 <lock_release+0x11ea>
  ...
  unlink("12345678901234");
    ...
    3120:	05c50513          	addi	a0,a0,92 # 7178 <lock_release+0x102a>
    ...
    313c:	08850513          	addi	a0,a0,136 # 71c0 <lock_release+0x1072>
    ...
    3158:	0d450513          	addi	a0,a0,212 # 7228 <lock_release+0x10da>
    ...
    3174:	13050513          	addi	a0,a0,304 # 72a0 <lock_release+0x1152>
    ...
    3190:	17450513          	addi	a0,a0,372 # 7300 <lock_release+0x11b2>
    ...
    31ac:	1b050513          	addi	a0,a0,432 # 7358 <lock_release+0x120a>
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	19c50513          	addi	a0,a0,412 # 7390 <lock_release+0x1242>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	18250513          	addi	a0,a0,386 # 73a0 <lock_release+0x1252>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	0e250513          	addi	a0,a0,226 # 7390 <lock_release+0x1242>
  ...
  unlink("diskfulldir");
    ...
    32c6:	0ce50513          	addi	a0,a0,206 # 7390 <lock_release+0x1242>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	fd050513          	addi	a0,a0,-48 # 73c0 <lock_release+0x1272>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	fe250513          	addi	a0,a0,-30 # 73f0 <lock_release+0x12a2>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	fce50513          	addi	a0,a0,-50 # 73f0 <lock_release+0x12a2>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	ffa50513          	addi	a0,a0,-6 # 7430 <lock_release+0x12e2>
  ...
  if(chdir("/") < 0){
    ...
    344e:	01650513          	addi	a0,a0,22 # 7460 <lock_release+0x1312>
    ...
    346e:	f8e50513          	addi	a0,a0,-114 # 73f8 <lock_release+0x12aa>
    ...
    348a:	f8a50513          	addi	a0,a0,-118 # 7410 <lock_release+0x12c2>
    ...
    34a6:	f9e50513          	addi	a0,a0,-98 # 7440 <lock_release+0x12f2>
    ...
    34c2:	faa50513          	addi	a0,a0,-86 # 7468 <lock_release+0x131a>
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	efe50513          	addi	a0,a0,-258 # 73f0 <lock_release+0x12a2>
    ...
    350a:	eea50513          	addi	a0,a0,-278 # 73f0 <lock_release+0x12a2>
    ...
    351e:	f1650513          	addi	a0,a0,-234 # 7430 <lock_release+0x12e2>
    ...
    353e:	4f650513          	addi	a0,a0,1270 # 6a30 <lock_release+0x8e2>
    ...
    355a:	ea250513          	addi	a0,a0,-350 # 73f8 <lock_release+0x12aa>
    ...
    3576:	f0e50513          	addi	a0,a0,-242 # 7480 <lock_release+0x1332>
    ...
    3592:	eb250513          	addi	a0,a0,-334 # 7440 <lock_release+0x12f2>
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	ecc50513          	addi	a0,a0,-308 # 7498 <lock_release+0x134a>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	eb850513          	addi	a0,a0,-328 # 7498 <lock_release+0x134a>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	ec450513          	addi	a0,a0,-316 # 74b8 <lock_release+0x136a>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	e9050513          	addi	a0,a0,-368 # 7498 <lock_release+0x134a>
    ...
    362c:	dd050513          	addi	a0,a0,-560 # 73f8 <lock_release+0x12aa>
    ...
    3648:	e5c50513          	addi	a0,a0,-420 # 74a0 <lock_release+0x1352>
    ...
    3664:	e6050513          	addi	a0,a0,-416 # 74c0 <lock_release+0x1372>
    ...
    3680:	e5c50513          	addi	a0,a0,-420 # 74d8 <lock_release+0x138a>
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	f7c50513          	addi	a0,a0,-132 # 7620 <lock_release+0x14d2>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	564080e7          	jalr	1380(ra) # 5c10 <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	e3c50513          	addi	a0,a0,-452 # 74f0 <lock_release+0x13a2>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	e4450513          	addi	a0,a0,-444 # 7510 <lock_release+0x13c2>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	f3c58593          	addi	a1,a1,-196 # 7620 <lock_release+0x14d2>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	df250513          	addi	a0,a0,-526 # 74f0 <lock_release+0x13a2>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	e5650513          	addi	a0,a0,-426 # 7568 <lock_release+0x141a>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	e6650513          	addi	a0,a0,-410 # 7590 <lock_release+0x1442>
  ...
  write(fd, "FF", 2);
    ...
    3746:	e7e58593          	addi	a1,a1,-386 # 75c0 <lock_release+0x1472>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	e6a50513          	addi	a0,a0,-406 # 75c8 <lock_release+0x147a>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	e7258593          	addi	a1,a1,-398 # 7618 <lock_release+0x14ca>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	de250513          	addi	a0,a0,-542 # 7590 <lock_release+0x1442>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	dce50513          	addi	a0,a0,-562 # 7590 <lock_release+0x1442>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	db850513          	addi	a0,a0,-584 # 7590 <lock_release+0x1442>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	d0450513          	addi	a0,a0,-764 # 74f0 <lock_release+0x13a2>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	eb050513          	addi	a0,a0,-336 # 76b0 <lock_release+0x1562>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	ecc50513          	addi	a0,a0,-308 # 76e0 <lock_release+0x1592>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	ee850513          	addi	a0,a0,-280 # 7710 <lock_release+0x15c2>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	dda50513          	addi	a0,a0,-550 # 7618 <lock_release+0x14ca>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	d1850513          	addi	a0,a0,-744 # 7590 <lock_release+0x1442>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	f1050513          	addi	a0,a0,-240 # 77a0 <lock_release+0x1652>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	f2850513          	addi	a0,a0,-216 # 77d0 <lock_release+0x1682>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	c3050513          	addi	a0,a0,-976 # 74f0 <lock_release+0x13a2>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	c1a50513          	addi	a0,a0,-998 # 74f0 <lock_release+0x13a2>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	c0450513          	addi	a0,a0,-1020 # 74f0 <lock_release+0x13a2>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	f6058593          	addi	a1,a1,-160 # 7860 <lock_release+0x1712>
    3908:	00004517          	auipc	a0,0x4
    390c:	e9850513          	addi	a0,a0,-360 # 77a0 <lock_release+0x1652>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	f4458593          	addi	a1,a1,-188 # 7860 <lock_release+0x1712>
    3924:	00004517          	auipc	a0,0x4
    3928:	eac50513          	addi	a0,a0,-340 # 77d0 <lock_release+0x1682>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	ce058593          	addi	a1,a1,-800 # 7618 <lock_release+0x14ca>
    3940:	00004517          	auipc	a0,0x4
    3944:	bd050513          	addi	a0,a0,-1072 # 7510 <lock_release+0x13c2>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	e4c50513          	addi	a0,a0,-436 # 77a0 <lock_release+0x1652>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	e6850513          	addi	a0,a0,-408 # 77d0 <lock_release+0x1682>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	c9c50513          	addi	a0,a0,-868 # 7618 <lock_release+0x14ca>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	e4050513          	addi	a0,a0,-448 # 77d0 <lock_release+0x1682>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	dfc50513          	addi	a0,a0,-516 # 77a0 <lock_release+0x1652>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	b5850513          	addi	a0,a0,-1192 # 7510 <lock_release+0x13c2>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	fe450513          	addi	a0,a0,-28 # 79b0 <lock_release+0x1862>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	c3850513          	addi	a0,a0,-968 # 7618 <lock_release+0x14ca>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	b1c50513          	addi	a0,a0,-1252 # 7510 <lock_release+0x13c2>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	ae850513          	addi	a0,a0,-1304 # 74f0 <lock_release+0x13a2>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	00450513          	addi	a0,a0,4 # 7a20 <lock_release+0x18d2>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	ac050513          	addi	a0,a0,-1344 # 74f0 <lock_release+0x13a2>
    ...
    3a56:	aa650513          	addi	a0,a0,-1370 # 74f8 <lock_release+0x13aa>
    ...
    3a72:	aaa50513          	addi	a0,a0,-1366 # 7518 <lock_release+0x13ca>
    ...
    3a8e:	aae50513          	addi	a0,a0,-1362 # 7538 <lock_release+0x13ea>
    ...
    3aaa:	aca50513          	addi	a0,a0,-1334 # 7570 <lock_release+0x1422>
    ...
    3ac6:	ade50513          	addi	a0,a0,-1314 # 75a0 <lock_release+0x1452>
    ...
    3ae2:	afa50513          	addi	a0,a0,-1286 # 75d8 <lock_release+0x148a>
    ...
    3afe:	afe50513          	addi	a0,a0,-1282 # 75f8 <lock_release+0x14aa>
    ...
    3b1a:	b1250513          	addi	a0,a0,-1262 # 7628 <lock_release+0x14da>
    ...
    3b36:	b1e50513          	addi	a0,a0,-1250 # 7650 <lock_release+0x1502>
    ...
    3b52:	b2250513          	addi	a0,a0,-1246 # 7670 <lock_release+0x1522>
    ...
    3b6e:	b2e50513          	addi	a0,a0,-1234 # 7698 <lock_release+0x154a>
    ...
    3b8a:	b3a50513          	addi	a0,a0,-1222 # 76c0 <lock_release+0x1572>
    ...
    3ba6:	b4e50513          	addi	a0,a0,-1202 # 76f0 <lock_release+0x15a2>
    ...
    3bc2:	b5a50513          	addi	a0,a0,-1190 # 7718 <lock_release+0x15ca>
    ...
    3bde:	b5650513          	addi	a0,a0,-1194 # 7730 <lock_release+0x15e2>
    ...
    3bfa:	b5a50513          	addi	a0,a0,-1190 # 7750 <lock_release+0x1602>
    ...
    3c16:	b5e50513          	addi	a0,a0,-1186 # 7770 <lock_release+0x1622>
    ...
    3c32:	b8250513          	addi	a0,a0,-1150 # 77b0 <lock_release+0x1662>
    ...
    3c4e:	b9650513          	addi	a0,a0,-1130 # 77e0 <lock_release+0x1692>
    ...
    3c6a:	b9a50513          	addi	a0,a0,-1126 # 7800 <lock_release+0x16b2>
    ...
    3c86:	b9e50513          	addi	a0,a0,-1122 # 7820 <lock_release+0x16d2>
    ...
    3ca2:	ba250513          	addi	a0,a0,-1118 # 7840 <lock_release+0x16f2>
    ...
    3cbe:	bb650513          	addi	a0,a0,-1098 # 7870 <lock_release+0x1722>
    ...
    3cda:	bc250513          	addi	a0,a0,-1086 # 7898 <lock_release+0x174a>
    ...
    3cf6:	bce50513          	addi	a0,a0,-1074 # 78c0 <lock_release+0x1772>
    ...
    3d12:	bda50513          	addi	a0,a0,-1062 # 78e8 <lock_release+0x179a>
    ...
    3d2e:	bde50513          	addi	a0,a0,-1058 # 7908 <lock_release+0x17ba>
    ...
    3d4a:	be250513          	addi	a0,a0,-1054 # 7928 <lock_release+0x17da>
    ...
    3d66:	bee50513          	addi	a0,a0,-1042 # 7950 <lock_release+0x1802>
    ...
    3d82:	bf250513          	addi	a0,a0,-1038 # 7970 <lock_release+0x1822>
    ...
    3d9e:	bf650513          	addi	a0,a0,-1034 # 7990 <lock_release+0x1842>
    ...
    3dba:	c0250513          	addi	a0,a0,-1022 # 79b8 <lock_release+0x186a>
    ...
    3dd6:	87e50513          	addi	a0,a0,-1922 # 7650 <lock_release+0x1502>
    ...
    3df2:	bea50513          	addi	a0,a0,-1046 # 79d8 <lock_release+0x188a>
    ...
    3e0e:	bee50513          	addi	a0,a0,-1042 # 79f8 <lock_release+0x18aa>
    ...
    3e2a:	c0250513          	addi	a0,a0,-1022 # 7a28 <lock_release+0x18da>
    ...
    3e46:	c0650513          	addi	a0,a0,-1018 # 7a48 <lock_release+0x18fa>
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	bf850513          	addi	a0,a0,-1032 # 7a60 <lock_release+0x1912>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	be650513          	addi	a0,a0,-1050 # 7a60 <lock_release+0x1912>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	a0450513          	addi	a0,a0,-1532 # 6890 <lock_release+0x742>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	61a50513          	addi	a0,a0,1562 # 74b8 <lock_release+0x136a>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	5b050513          	addi	a0,a0,1456 # 7460 <lock_release+0x1312>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	c0650513          	addi	a0,a0,-1018 # 7ac8 <lock_release+0x197a>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	c1c50513          	addi	a0,a0,-996 # 7af0 <lock_release+0x19a2>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	b7a50513          	addi	a0,a0,-1158 # 7a60 <lock_release+0x1912>
    ...
    3f08:	b6450513          	addi	a0,a0,-1180 # 7a68 <lock_release+0x191a>
    ...
    3f24:	b6050513          	addi	a0,a0,-1184 # 7a80 <lock_release+0x1932>
    ...
    3f40:	b5c50513          	addi	a0,a0,-1188 # 7a98 <lock_release+0x194a>
    ...
    3f5c:	b5850513          	addi	a0,a0,-1192 # 7ab0 <lock_release+0x1962>
    ...
    3f78:	4f450513          	addi	a0,a0,1268 # 7468 <lock_release+0x131a>
    ...
    3f94:	b4050513          	addi	a0,a0,-1216 # 7ad0 <lock_release+0x1982>
    ...
    3fb0:	b4c50513          	addi	a0,a0,-1204 # 7af8 <lock_release+0x19aa>
    ...
    3fcc:	b5050513          	addi	a0,a0,-1200 # 7b18 <lock_release+0x19ca>
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	b4450513          	addi	a0,a0,-1212 # 7b38 <lock_release+0x19ea>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	b2850513          	addi	a0,a0,-1240 # 7b38 <lock_release+0x19ea>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	b5c50513          	addi	a0,a0,-1188 # 7b80 <lock_release+0x1a32>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	b4450513          	addi	a0,a0,-1212 # 7b80 <lock_release+0x1a32>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	b3050513          	addi	a0,a0,-1232 # 7b80 <lock_release+0x1a32>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	b1c50513          	addi	a0,a0,-1252 # 7b80 <lock_release+0x1a32>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	b0858593          	addi	a1,a1,-1272 # 7b80 <lock_release+0x1a32>
    4080:	00002517          	auipc	a0,0x2
    4084:	30050513          	addi	a0,a0,768 # 6380 <lock_release+0x232>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	aa450513          	addi	a0,a0,-1372 # 7b38 <lock_release+0x19ea>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	7e650513          	addi	a0,a0,2022 # 6890 <lock_release+0x742>
  ...
  fd = open(".", 0);
    ...
    40c4:	7d050513          	addi	a0,a0,2000 # 6890 <lock_release+0x742>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	14458593          	addi	a1,a1,324 # 6218 <lock_release+0xca>
  ...
  close(fd);
    ...
    4104:	a4050513          	addi	a0,a0,-1472 # 7b40 <lock_release+0x19f2>
    ...
    4120:	a4450513          	addi	a0,a0,-1468 # 7b60 <lock_release+0x1a12>
    ...
    413c:	a5850513          	addi	a0,a0,-1448 # 7b90 <lock_release+0x1a42>
    ...
    4158:	a3c50513          	addi	a0,a0,-1476 # 7b90 <lock_release+0x1a42>
    ...
    4174:	a4850513          	addi	a0,a0,-1464 # 7bb8 <lock_release+0x1a6a>
    ...
    4190:	a5450513          	addi	a0,a0,-1452 # 7be0 <lock_release+0x1a92>
    ...
    41ac:	a6050513          	addi	a0,a0,-1440 # 7c08 <lock_release+0x1aba>
    ...
    41c8:	a6c50513          	addi	a0,a0,-1428 # 7c30 <lock_release+0x1ae2>
    ...
    41e4:	a7050513          	addi	a0,a0,-1424 # 7c50 <lock_release+0x1b02>
    ...
    4200:	a7c50513          	addi	a0,a0,-1412 # 7c78 <lock_release+0x1b2a>
...
0000000000004216 <iref>:
{
    ...
    4234:	a60a0a13          	addi	s4,s4,-1440 # 7c90 <lock_release+0x1b42>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	56048493          	addi	s1,s1,1376 # 7798 <lock_release+0x164a>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	140a8a93          	addi	s5,s5,320 # 6380 <lock_release+0x232>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	94098993          	addi	s3,s3,-1728 # 7b88 <lock_release+0x1a3a>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	a4450513          	addi	a0,a0,-1468 # 7c98 <lock_release+0x1b4a>
    ...
    4274:	a4050513          	addi	a0,a0,-1472 # 7cb0 <lock_release+0x1b62>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	1b498993          	addi	s3,s3,436 # 74b8 <lock_release+0x136a>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	98490913          	addi	s2,s2,-1660 # 7c90 <lock_release+0x1b42>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	13450513          	addi	a0,a0,308 # 7460 <lock_release+0x1312>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	96c50513          	addi	a0,a0,-1684 # 7cc8 <lock_release+0x1b7a>
  ...
  if(pid == 0){
    ...
    4384:	94850513          	addi	a0,a0,-1720 # 7cc8 <lock_release+0x1b7a>
    ...
    439a:	95250513          	addi	a0,a0,-1710 # 7ce8 <lock_release+0x1b9a>
    ...
    43b6:	91e50513          	addi	a0,a0,-1762 # 7cd0 <lock_release+0x1b82>
    ...
    43d2:	66250513          	addi	a0,a0,1634 # 6a30 <lock_release+0x8e2>
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	8cc50513          	addi	a0,a0,-1844 # 7cc8 <lock_release+0x1b7a>
    ...
    4414:	81050513          	addi	a0,a0,-2032 # 6c20 <lock_release+0xad2>
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	8c250513          	addi	a0,a0,-1854 # 7d10 <lock_release+0x1bc2>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	89650513          	addi	a0,a0,-1898 # 7d10 <lock_release+0x1bc2>
  ...
  sleep(10); // one second
    ...
    44b6:	73e50513          	addi	a0,a0,1854 # 6bf0 <lock_release+0xaa2>
    ...
    44d0:	84448493          	addi	s1,s1,-1980 # 7d10 <lock_release+0x1bc2>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
...
0000000000004512 <killstatus>:
{
  ...
  exit(0);
    ...
    4578:	4bc50513          	addi	a0,a0,1212 # 6a30 <lock_release+0x8e2>
    ...
    459e:	78650513          	addi	a0,a0,1926 # 7d20 <lock_release+0x1bd2>
...
00000000000045b4 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45de:	61650513          	addi	a0,a0,1558 # 6bf0 <lock_release+0xaa2>
  ...
  if(pid2 == 0)
    ...
    460c:	42850513          	addi	a0,a0,1064 # 6a30 <lock_release+0x8e2>
  ...
  if(pid3 == 0){
    ...
    4650:	bcc58593          	addi	a1,a1,-1076 # 6218 <lock_release+0xca>
    ...
    467a:	3ba50513          	addi	a0,a0,954 # 6a30 <lock_release+0x8e2>
    ...
    4696:	6ae50513          	addi	a0,a0,1710 # 7d40 <lock_release+0x1bf2>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d2:	68a50513          	addi	a0,a0,1674 # 7d58 <lock_release+0x1c0a>
  ...
  printf("kill... ");
    ...
    46fe:	67650513          	addi	a0,a0,1654 # 7d70 <lock_release+0x1c22>
  ...
  printf("wait... ");
    ...
    472c:	65850513          	addi	a0,a0,1624 # 7d80 <lock_release+0x1c32>
...
0000000000004758 <reparent>:
{
  ...
  exit(0);
    ...
    47ac:	28850513          	addi	a0,a0,648 # 6a30 <lock_release+0x8e2>
    ...
    47c8:	3f450513          	addi	a0,a0,1012 # 6bb8 <lock_release+0xa6a>
...
0000000000004808 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    483e:	2fe50513          	addi	a0,a0,766 # 6b38 <lock_release+0x9ea>
    ...
    4872:	9aa58593          	addi	a1,a1,-1622 # 6218 <lock_release+0xca>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    4936:	45e50513          	addi	a0,a0,1118 # 7d90 <lock_release+0x1c42>
    ...
    4952:	0e250513          	addi	a0,a0,226 # 6a30 <lock_release+0x8e2>
    ...
    499e:	41650513          	addi	a0,a0,1046 # 7db0 <lock_release+0x1c62>
...
00000000000049be <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a42:	3a250513          	addi	a0,a0,930 # 7de0 <lock_release+0x1c92>
...
0000000000004a62 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4af8:	31c50513          	addi	a0,a0,796 # 7e10 <lock_release+0x1cc2>
    ...
    4b14:	32850513          	addi	a0,a0,808 # 7e38 <lock_release+0x1cea>
  ...
  fd = open("sharedfd", 0);
    ...
    4b58:	2ac50513          	addi	a0,a0,684 # 7e00 <lock_release+0x1cb2>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b98:	2c450513          	addi	a0,a0,708 # 7e58 <lock_release+0x1d0a>
  ...
  unlink("sharedfd");
    ...
    4bd4:	23050513          	addi	a0,a0,560 # 7e00 <lock_release+0x1cb2>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4bfa:	28a50513          	addi	a0,a0,650 # 7e80 <lock_release+0x1d32>
...
0000000000004c1a <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c40:	25c78793          	addi	a5,a5,604 # 7e98 <lock_release+0x1d4a>
    4c44:	f6f43823          	sd	a5,-144(s0)
    4c48:	00003797          	auipc	a5,0x3
    4c4c:	25878793          	addi	a5,a5,600 # 7ea0 <lock_release+0x1d52>
    4c50:	f6f43c23          	sd	a5,-136(s0)
    4c54:	00003797          	auipc	a5,0x3
    4c58:	25478793          	addi	a5,a5,596 # 7ea8 <lock_release+0x1d5a>
    4c5c:	f8f43023          	sd	a5,-128(s0)
    4c60:	00003797          	auipc	a5,0x3
    4c64:	25078793          	addi	a5,a5,592 # 7eb0 <lock_release+0x1d62>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cdc:	16050513          	addi	a0,a0,352 # 6e38 <lock_release+0xcea>
    ...
    4d58:	16450513          	addi	a0,a0,356 # 7eb8 <lock_release+0x1d6a>
    ...
    4d72:	15a50513          	addi	a0,a0,346 # 7ec8 <lock_release+0x1d7a>
    ...
    4d9a:	14a50513          	addi	a0,a0,330 # 7ee0 <lock_release+0x1d92>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e28:	0cc50513          	addi	a0,a0,204 # 7ef0 <lock_release+0x1da2>
...
0000000000004e5c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e8a:	082b8b93          	addi	s7,s7,130 # 7f08 <lock_release+0x1dba>
  for(i = 0; i < N; i++){
    ...
    4ecc:	04850513          	addi	a0,a0,72 # 7f10 <lock_release+0x1dc2>
    ...
    4eea:	02250513          	addi	a0,a0,34 # 7f08 <lock_release+0x1dba>
  ...
  fd = open(".", 0);
    ...
    4f22:	97250513          	addi	a0,a0,-1678 # 6890 <lock_release+0x742>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9a:	f9a50513          	addi	a0,a0,-102 # 7f30 <lock_release+0x1de2>
    ...
    4fba:	f9a50513          	addi	a0,a0,-102 # 7f50 <lock_release+0x1e02>
  ...
  for(i = 0; i < N; i++){
    ...
    4ff2:	f8a50513          	addi	a0,a0,-118 # 7f78 <lock_release+0x1e2a>
    ...
    500e:	a2650513          	addi	a0,a0,-1498 # 6a30 <lock_release+0x8e2>
...
00000000000051b8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5240:	d7450513          	addi	a0,a0,-652 # 7fb0 <lock_release+0x1e62>
  ...
  for(i = 0; ; i++){
    ...
    52a4:	d2050513          	addi	a0,a0,-736 # 7fc0 <lock_release+0x1e72>
    ...
    52c0:	d2450513          	addi	a0,a0,-732 # 7fe0 <lock_release+0x1e92>
    ...
    52dc:	d2850513          	addi	a0,a0,-728 # 8000 <lock_release+0x1eb2>
    ...
    52f8:	d2c50513          	addi	a0,a0,-724 # 8020 <lock_release+0x1ed2>
    ...
    5314:	d3050513          	addi	a0,a0,-720 # 8040 <lock_release+0x1ef2>
    ...
    5330:	d2c50513          	addi	a0,a0,-724 # 8058 <lock_release+0x1f0a>
  ...
  unlink("bigfile.dat");
    ...
    535e:	c5650513          	addi	a0,a0,-938 # 7fb0 <lock_release+0x1e62>
    ...
    5382:	cfa50513          	addi	a0,a0,-774 # 8078 <lock_release+0x1f2a>
...
0000000000005398 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53ba:	ce250513          	addi	a0,a0,-798 # 8098 <lock_release+0x1f4a>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53da:	cd2c8c93          	addi	s9,s9,-814 # 80a8 <lock_release+0x1f5a>
    int total = 0;
    53de:	4d81                	li	s11,0
    ...
    5454:	c6850513          	addi	a0,a0,-920 # 80b8 <lock_release+0x1f6a>
  ...
  printf("fsfull test finished\n");
    ...
    54ca:	c1250513          	addi	a0,a0,-1006 # 80d8 <lock_release+0x1f8a>
    ...
    551a:	bb250513          	addi	a0,a0,-1102 # 80c8 <lock_release+0x1f7a>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    554c:	ba850513          	addi	a0,a0,-1112 # 80f0 <lock_release+0x1fa2>
  ...
  if(pid == 0) {
    ...
    557c:	ba050513          	addi	a0,a0,-1120 # 8118 <lock_release+0x1fca>
    ...
    55a0:	b6450513          	addi	a0,a0,-1180 # 8100 <lock_release+0x1fb2>
    ...
    55c8:	b5c50513          	addi	a0,a0,-1188 # 8120 <lock_release+0x1fd2>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5618:	b1450513          	addi	a0,a0,-1260 # 8128 <lock_release+0x1fda>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5672:	baa98993          	addi	s3,s3,-1110 # 6218 <lock_release+0xca>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a4:	ae050513          	addi	a0,a0,-1312 # 8180 <lock_release+0x2032>
    ...
    56be:	a8650513          	addi	a0,a0,-1402 # 8140 <lock_release+0x1ff2>
    ...
    56d8:	a8c50513          	addi	a0,a0,-1396 # 8160 <lock_release+0x2012>
  ...
  while(1){
    ...
    5726:	a7e50513          	addi	a0,a0,-1410 # 81a0 <lock_release+0x2052>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5788:	a3cb8b93          	addi	s7,s7,-1476 # 81c0 <lock_release+0x2072>
    int free0 = countfree();
    int free1 = 0;
    ...
    579a:	a62c8c93          	addi	s9,s9,-1438 # 81f8 <lock_release+0x20aa>
      if (runtests(slowtests, justone)) {
    579e:	00004c17          	auipc	s8,0x4
    57a2:	c42c0c13          	addi	s8,s8,-958 # 93e0 <slowtests>
        printf("usertests slow tests starting\n");
    57a6:	00003d17          	auipc	s10,0x3
    57aa:	a32d0d13          	addi	s10,s10,-1486 # 81d8 <lock_release+0x208a>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    589e:	98e58593          	addi	a1,a1,-1650 # 8228 <lock_release+0x20da>
    ...
    58b6:	9ce58593          	addi	a1,a1,-1586 # 8280 <lock_release+0x2132>
    ...
    58cc:	9b058593          	addi	a1,a1,-1616 # 8278 <lock_release+0x212a>
  ...
  int continuous = 0;
    ...
    58f8:	93c50513          	addi	a0,a0,-1732 # 8230 <lock_release+0x20e2>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5924:	94050513          	addi	a0,a0,-1728 # 8260 <lock_release+0x2112>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cb0:	99c50513          	addi	a0,a0,-1636 # 8648 <digits>
    5cb4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d6a:	4c55                	li	s8,21
    5d6c:	00003c97          	auipc	s9,0x3
    5d70:	884c8c93          	addi	s9,s9,-1916 # 85f0 <lock_release+0x24a2>
  ...
  putc(fd, 'x');
    ...
    5d7e:	8ceb8b93          	addi	s7,s7,-1842 # 8648 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5ea4:	74898993          	addi	s3,s3,1864 # 85e8 <lock_release+0x249a>
        while(*s != 0){
    5ea8:	85ee                	mv	a1,s11
...
00000000000060e0 <thread_create>:
#include "user/user.h"
...
{
    60e0:	1101                	addi	sp,sp,-32
    60e2:	ec06                	sd	ra,24(sp)
    60e4:	e822                	sd	s0,16(sp)
    60e6:	e426                	sd	s1,8(sp)
    60e8:	e04a                	sd	s2,0(sp)
    60ea:	1000                	addi	s0,sp,32
    60ec:	84aa                	mv	s1,a0
    60ee:	892e                	mv	s2,a1
	int stksz = 4096 * sizeof(void);
	void* stk_addr = (void*) malloc(stksz);
    60f0:	6505                	lui	a0,0x1
    60f2:	00000097          	auipc	ra,0x0
    60f6:	f08080e7          	jalr	-248(ra) # 5ffa <malloc>
	
	int tid  = clone(stk_addr,stksz);
    60fa:	6585                	lui	a1,0x1
    60fc:	00000097          	auipc	ra,0x0
    6100:	b64080e7          	jalr	-1180(ra) # 5c60 <clone>
	
	if(tid == 0) {
    6104:	c901                	beqz	a0,6114 <thread_create+0x34>
		(*start_routine) (arg);
		exit(0);
	}
	return 0;
    ...
    6106:	4501                	li	a0,0
    6108:	60e2                	ld	ra,24(sp)
    610a:	6442                	ld	s0,16(sp)
    610c:	64a2                	ld	s1,8(sp)
    610e:	6902                	ld	s2,0(sp)
    6110:	6105                	addi	sp,sp,32
    6112:	8082                	ret
		(*start_routine) (arg);
    6114:	854a                	mv	a0,s2
    6116:	9482                	jalr	s1
    ...
    611e:	aa6080e7          	jalr	-1370(ra) # 5bc0 <exit>

0000000000006122 <lock_init>:
...
void lock_init(lock_t *lock)
{
	...
	*lock = 0;
    6128:	00052023          	sw	zero,0(a0) # 1000 <linktest+0x10c>
}
    612c:	6422                	ld	s0,8(sp)
    612e:	0141                	addi	sp,sp,16
    6130:	8082                	ret

0000000000006132 <lock_acquire>:
void lock_acquire(lock_t *lock)
{
    ...
    6138:	4705                	li	a4,1
    613a:	87ba                	mv	a5,a4
    613c:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
    6140:	2781                	sext.w	a5,a5
    6142:	ffe5                	bnez	a5,613a <lock_acquire+0x8>
	__sync_synchronize();
    6144:	0ff0000f          	fence
}
    6148:	6422                	ld	s0,8(sp)
    614a:	0141                	addi	sp,sp,16
    614c:	8082                	ret

000000000000614e <lock_release>:
void lock_release(lock_t *lock)
{
    614e:	1141                	addi	sp,sp,-16
    6150:	e422                	sd	s0,8(sp)
    6152:	0800                	addi	s0,sp,16
	__sync_synchronize();
    6154:	0ff0000f          	fence
	__sync_lock_release(lock,0);
    6158:	0f50000f          	fence	iorw,ow
    615c:	0805202f          	amoswap.w	zero,zero,(a0)
}
