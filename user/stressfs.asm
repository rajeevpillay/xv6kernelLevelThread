...
main(int argc, char *argv[])
{
  ...
  1a:	95a78793          	addi	a5,a5,-1702 # 970 <lock_release+0x50>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	91450513          	addi	a0,a0,-1772 # 940 <lock_release+0x20>
  ...
  6c:	8f050513          	addi	a0,a0,-1808 # 958 <lock_release+0x38>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	8b250513          	addi	a0,a0,-1870 # 968 <lock_release+0x48>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 542:	44ac8c93          	addi	s9,s9,1098 # 988 <lock_release+0x68>
 ...
 550:	494b8b93          	addi	s7,s7,1172 # 9e0 <digits>
 ...
 676:	30e98993          	addi	s3,s3,782 # 980 <lock_release+0x60>
        while(*s != 0){
 67a:	85ee                	mv	a1,s11
...
int thread_create(void *(*start_routine)(void*), void *arg) 
{
 ...
 8d2:	b64080e7          	jalr	-1180(ra) # 432 <clone>
	
	if(tid == 0) {
 8d6:	c901                	beqz	a0,8e6 <thread_create+0x34>
		(*start_routine) (arg);
		exit(0);
	}
	return 0;
 ...
 8f0:	aa6080e7          	jalr	-1370(ra) # 392 <exit>

00000000000008f4 <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 8f8:	0800                	addi	s0,sp,16
	*lock = 0;
 8fa:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 8fe:	6422                	ld	s0,8(sp)
 900:	0141                	addi	sp,sp,16
 902:	8082                	ret

0000000000000904 <lock_acquire>:
void lock_acquire(lock_t *lock)
{
 ...
 90a:	4705                	li	a4,1
 90c:	87ba                	mv	a5,a4
 90e:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 912:	2781                	sext.w	a5,a5
 914:	ffe5                	bnez	a5,90c <lock_acquire+0x8>
	__sync_synchronize();
 916:	0ff0000f          	fence
}
 91a:	6422                	ld	s0,8(sp)
...
void lock_release(lock_t *lock)
{
 ...
 92a:	0f50000f          	fence	iorw,ow
 92e:	0805202f          	amoswap.w	zero,zero,(a0)
}
 932:	6422                	ld	s0,8(sp)
