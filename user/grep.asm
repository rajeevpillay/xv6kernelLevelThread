...
00000000000001de <main>:
{
 ...
 252:	88258593          	addi	a1,a1,-1918 # ad0 <lock_release+0x1e>
 256:	4509                	li	a0,2
 ...
 288:	86c50513          	addi	a0,a0,-1940 # af0 <lock_release+0x3e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 614:	55850513          	addi	a0,a0,1368 # b68 <digits>
 618:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6d4:	440c8c93          	addi	s9,s9,1088 # b10 <lock_release+0x5e>
 ...
 6e2:	48ab8b93          	addi	s7,s7,1162 # b68 <digits>
 ...
 808:	30498993          	addi	s3,s3,772 # b08 <lock_release+0x56>
        while(*s != 0){
 80c:	85ee                	mv	a1,s11
...
0000000000000a44 <thread_create>:
#include "user/user.h"
...
int thread_create(void *(*start_routine)(void*), void *arg) 
{
 ...
 a5a:	f08080e7          	jalr	-248(ra) # 95e <malloc>
	
	int tid  = clone(stk_addr,stksz);
 a5e:	6585                	lui	a1,0x1
 a60:	00000097          	auipc	ra,0x0
 a64:	b64080e7          	jalr	-1180(ra) # 5c4 <clone>
	
	if(tid == 0) {
 a68:	c901                	beqz	a0,a78 <thread_create+0x34>
		(*start_routine) (arg);
		exit(0);
	}
	return 0;
 ...
 a82:	aa6080e7          	jalr	-1370(ra) # 524 <exit>

0000000000000a86 <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 a8a:	0800                	addi	s0,sp,16
	*lock = 0;
 a8c:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 a90:	6422                	ld	s0,8(sp)
 a92:	0141                	addi	sp,sp,16
 a94:	8082                	ret

0000000000000a96 <lock_acquire>:
void lock_acquire(lock_t *lock)
{
 ...
 a9c:	4705                	li	a4,1
 a9e:	87ba                	mv	a5,a4
 aa0:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 aa4:	2781                	sext.w	a5,a5
 aa6:	ffe5                	bnez	a5,a9e <lock_acquire+0x8>
	__sync_synchronize();
 aa8:	0ff0000f          	fence
}
 aac:	6422                	ld	s0,8(sp)
...
void lock_release(lock_t *lock)
{
 ...
 abc:	0f50000f          	fence	iorw,ow
 ac0:	0805202f          	amoswap.w	zero,zero,(a0)
}
 ac4:	6422                	ld	s0,8(sp)
