...
cat(int fd)
{
  ...
  44:	91058593          	addi	a1,a1,-1776 # 950 <lock_release+0x1e>
  48:	4509                	li	a0,2
  ...
  72:	8fa58593          	addi	a1,a1,-1798 # 968 <lock_release+0x36>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	87e58593          	addi	a1,a1,-1922 # 980 <lock_release+0x4e>
 10a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 494:	56850513          	addi	a0,a0,1384 # 9f8 <digits>
 498:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 554:	450c8c93          	addi	s9,s9,1104 # 9a0 <lock_release+0x6e>
 ...
 562:	49ab8b93          	addi	s7,s7,1178 # 9f8 <digits>
 ...
 688:	31498993          	addi	s3,s3,788 # 998 <lock_release+0x66>
        while(*s != 0){
 68c:	85ee                	mv	a1,s11
...
00000000000008c4 <thread_create>:
#include "user/user.h"
...
int thread_create(void *(*start_routine)(void*), void *arg) 
{
 ...
 8da:	f08080e7          	jalr	-248(ra) # 7de <malloc>
	
	int tid  = clone(stk_addr,stksz);
 8de:	6585                	lui	a1,0x1
 8e0:	00000097          	auipc	ra,0x0
 8e4:	b64080e7          	jalr	-1180(ra) # 444 <clone>
	
	if(tid == 0) {
 8e8:	c901                	beqz	a0,8f8 <thread_create+0x34>
		(*start_routine) (arg);
		exit(0);
	}
	return 0;
 ...
 902:	aa6080e7          	jalr	-1370(ra) # 3a4 <exit>
...
void lock_init(lock_t *lock)
{
 ...
 90a:	0800                	addi	s0,sp,16
	*lock = 0;
 90c:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 910:	6422                	ld	s0,8(sp)
