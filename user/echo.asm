...
main(int argc, char *argv[])
{
  ...
  2e:	886a0a13          	addi	s4,s4,-1914 # 8b0 <lock_release+0x18>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	85058593          	addi	a1,a1,-1968 # 8b8 <lock_release+0x20>
  70:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ba:	412c8c93          	addi	s9,s9,1042 # 8c8 <lock_release+0x30>
 ...
 4c8:	45cb8b93          	addi	s7,s7,1116 # 920 <digits>
 ...
 5ee:	2d698993          	addi	s3,s3,726 # 8c0 <lock_release+0x28>
        while(*s != 0){
 5f2:	85ee                	mv	a1,s11
...
int thread_create(void *(*start_routine)(void*), void *arg) 
{
 ...
 840:	f08080e7          	jalr	-248(ra) # 744 <malloc>
	
	int tid  = clone(stk_addr,stksz);
 844:	6585                	lui	a1,0x1
 846:	00000097          	auipc	ra,0x0
 84a:	b64080e7          	jalr	-1180(ra) # 3aa <clone>
	
	if(tid == 0) {
 84e:	c901                	beqz	a0,85e <thread_create+0x34>
		(*start_routine) (arg);
		exit(0);
	}
	return 0;
 ...
 868:	aa6080e7          	jalr	-1370(ra) # 30a <exit>

000000000000086c <lock_init>:
...
void lock_init(lock_t *lock)
{
 ...
 870:	0800                	addi	s0,sp,16
	*lock = 0;
 872:	00052023          	sw	zero,0(a0) # 1000 <freep>
}
 876:	6422                	ld	s0,8(sp)
 878:	0141                	addi	sp,sp,16
 87a:	8082                	ret

000000000000087c <lock_acquire>:
void lock_acquire(lock_t *lock)
{
 ...
 882:	4705                	li	a4,1
 884:	87ba                	mv	a5,a4
 886:	0cf527af          	amoswap.w.aq	a5,a5,(a0)
 88a:	2781                	sext.w	a5,a5
 88c:	ffe5                	bnez	a5,884 <lock_acquire+0x8>
	__sync_synchronize();
 88e:	0ff0000f          	fence
}
 892:	6422                	ld	s0,8(sp)
...
void lock_release(lock_t *lock)
{
 ...
 8a2:	0f50000f          	fence	iorw,ow
 8a6:	0805202f          	amoswap.w	zero,zero,(a0)
}
 8aa:	6422                	ld	s0,8(sp)
